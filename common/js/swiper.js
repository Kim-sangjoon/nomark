...
!(function (e, t) {
                                ...
                                p[I] && (p[I].swiperSlideSize = C),
                                    ...
                                    i.centeredSlides
                                        ? ((y = y + C / 2 + E / 2 + w),
                                          ...
                                          h.push(y))
                                        : (i.roundLengths && (y = Math.floor(y)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && c.push(y), h.push(y), (y = y + C + w)),
                                    (e.virtualSize += C + w),
                                    (E = C),
                                    (x += 1);
                            }
                ...
                setBreakpoint: function () {
                    ...
                    if (l && (!l || 0 !== Object.keys(l).length)) {
                        ...
                        if (o && e.currentBreakpoint !== o) {
                            ...
                            M(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
    ...
    var j = {
            update: function (e) {
                ...
                if ((M(t.virtual, { from: y, to: E, offset: x, slidesGrid: t.slidesGrid }), p === y && u === E && !e)) return t.slidesGrid !== h && x !== f && t.slides.css(m, x + "px"), void t.updateProgress();
    ...
    var J = {
        ...
        Q = {
            ...
            init: function () {
                ...
                ((a.params.navigation = k(a.$el, a.params.navigation, a.params.createElements, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" })), i.nextEl || i.prevEl) &&
            ...
            init: function () {
                ...
                return (
                    t.swiper instanceof a
                        ? ((e.thumbs.swiper = t.swiper), M(e.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), M(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
                        : C(t.swiper) && ((e.thumbs.swiper = new a(M({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
